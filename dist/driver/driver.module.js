...
exports.DriverModule = DriverModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, auth_module_1.AuthModule, transport_module_1.TransportModule],
        controllers: [driver_controller_1.DriverController],
        providers: [location_service_1.LocationService, driver_mvp_service_1.DriverMvpService],
