...
export class CustomersController {
  ...
  @ApiOperation({ summary: "Get a customer company profile (tenant-safe)" })
  async getCompany(@Request() req: any, @Param("companyId") companyId: string) {
    const tenantId = req.tenant.tenantId;
    return this.customersService.getCompany(tenantId, companyId);
  }
  ...
  async updateCompany(
    @Request() req: any,
    @Param("companyId") companyId: string,
    @Body() dto: UpdateCustomerCompanyDto,
  ) {
    const tenantId = req.tenant.tenantId;
