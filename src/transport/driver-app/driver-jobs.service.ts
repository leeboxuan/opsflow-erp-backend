...
export class DriverJobsService {
  ...
  private async buildDriverDailyRunSheet(
      ...
      compareTripsByEffectiveSchedule(
        {
          ...
          jobPickupDateHasTime: a.job?.pickupDateHasTime,
        ...
        },
        {
          ...
          jobPickupDateHasTime: b.job?.pickupDateHasTime,
    ...
    const runRows = sorted.map((t: any) => ({
      ...
      jobPickupDateHasTime: t.job?.pickupDateHasTime ?? null,
    ...
    const items = sorted.map((t: any) => {
      ...
      return {
        ...
        pickupDateHasTime: t.job?.pickupDateHasTime ?? null,
  ...
  async startTripWithTrailer(
    ...
    const startGate = evaluateTripStartDateGate({
      ...
      jobPickupDateHasTime:
        (job as { pickupDateHasTime?: boolean | null }).pickupDateHasTime ?? null,
      timeZone: tz,
    });
    ...
    const siblingTrips = await this.prisma.trip.findMany({
      ...
      select: {
        ...
        job: { select: { pickupDate: true, pickupDateHasTime: true } },
      },
    });
    const blockingEarlier = findBlockingEarlierDriverTrip({
      ...
      trips: siblingTrips.map((row) => ({
        ...
        jobPickupDateHasTime: row.job?.pickupDateHasTime ?? null,
    ...
    return {
      ...
      job: trip.job
        ? {
            ...
            pickupDateHasTime: trip.job.pickupDateHasTime ?? null,
            deliveryDate: trip.job.deliveryDate ?? null,
            deliveryDateHasTime: trip.job.deliveryDateHasTime ?? null,
